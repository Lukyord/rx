    ...
    if ($("*[data-split]").length) {
        ...
        $("*[data-split][data-split-animate]")
            ...
            .each(function (index) {
                ...
                $(this).wrapInner(`<span class="word-animate animate" style="animation-delay: ${delay}s"></span>`);
            });
    }
});
...
jQuery(document).ready(function ($) {
    ...
    if ($(".swiper.auto").length) {
        $(".swiper.auto").each(function () {
                ...
                pagination: {
                    ...
                    renderCustom: function (swiper, current, total) {
                        ...
                        for (let i = 1; i <= total; i++) {
                            paginationHtml += `<span class="swiper-pagination-custom-number ${
                                i === current ? "active" : ""
                            }" data-index="${(i - 1) * 3 + 1}">${i}</span>`;
                        }
            ...
            $(".swiper-pagination").on("click", ".swiper-pagination-custom-number", function () {
                console.log("Button index:", $(this).data("index"));
...
jQuery(document).ready(function ($) {
    ...
    // TOGGLE SUBMENU: PC
    $(".has-submenu > a").on("mouseenter", function (e) {
        e.preventDefault();
    ...
    $(".menu > li:not(.has-submenu)").on("mouseenter", function () {
        closeSubmenu();
    });
